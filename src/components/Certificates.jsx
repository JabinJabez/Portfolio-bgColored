      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {certificates.map((cert, index) => (
            <div key={index} className="bg-gray-950 shadow-lg rounded-lg border-1 border-black overflow-hidden transform transition-all duration-300 hover:scale-105">
              ...
              <div className="p-4 text-center">
                ...
                <a href={cert.link} target="_blank" className="text-blue-600 font-bold mt-2 block">
                  View Certificate
                </a>
              </div>
            </div>
